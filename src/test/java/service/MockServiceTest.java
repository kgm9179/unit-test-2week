...
public class MockServiceTest {
    ...
    @Test
    public void 어떠한챔피언포지션을입력해도무조건미드리턴테스트() {
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void TestFor_4_4() {
        Champion champion = mock(Champion.class);
        champion.setName("제드");
        champion.setPosition("미드");
        champion.setHasSkinCount(2);
        verify(champion, timeout(200).atLeastOnce()).setName(any());
    ...
    public void List객체사이즈검증테스트() {
        ...
        champions.add(new Champion("이즈리얼", "원딜", 3));
        champions.add(new Champion("징크스", "원딜", 3));
